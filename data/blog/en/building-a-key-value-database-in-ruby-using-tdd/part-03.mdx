---
title: "Building a key-value database in Ruby using TDD: Part 03"
series:
  order: 3
...
draft: false
featured: false
summary: In this third part, we'll keep working on the tests and implementations to serialize and deserialize data.
---
