---
title: "Building a key-value database in Ruby using TDD: Part 02"
series:
  order: 2
...
draft: false
featured: false
summary: In this second part, we'll start working on the tests and implementations to serialize and deserialize data.
---
