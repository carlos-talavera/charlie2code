...
export default async function PostLayout({
  ...
  const { slug, date, title, language, series, toc, tags, readingTime } = content
              ...
              <div className="space-y-1 border-b border-gray-200 pb-10 dark:border-gray-700">
                ...
                <dl>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <span>⏳</span>
                      <span className="ml-1.5 text-base font-medium leading-6 text-gray-500 dark:text-gray-400 md:ml-2">
                        {Math.ceil(readingTime.minutes)} {t('readingtime')}
                      </span>
                    </div>
                  </div>
                </dl>
